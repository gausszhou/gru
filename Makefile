...
build-linux:
	...
	tar czf $(DIST_DIR)/$(BINARY_NAME)-linux-amd64.tar.gz --transform='s,.*,gru,' -C $(BIN_DIR) $(BINARY_NAME)-linux-amd64
	tar czf $(DIST_DIR)/$(BINARY_NAME)-linux-arm64.tar.gz --transform='s,.*,gru,' -C $(BIN_DIR) $(BINARY_NAME)-linux-arm64
...
build-darwin:
	...
	tar czf $(DIST_DIR)/$(BINARY_NAME)-darwin-amd64.tar.gz --transform='s,.*,gru,' -C $(BIN_DIR) $(BINARY_NAME)-darwin-amd64
	tar czf $(DIST_DIR)/$(BINARY_NAME)-darwin-arm64.tar.gz --transform='s,.*,gru,' -C $(BIN_DIR) $(BINARY_NAME)-darwin-arm64
...
build-windows:
	...
	tar czf $(DIST_DIR)/$(BINARY_NAME)-windows-amd64.tar.gz --transform='s,.*,gru.exe,' -C $(BIN_DIR) $(BINARY_NAME)-windows-amd64.exe
	tar czf $(DIST_DIR)/$(BINARY_NAME)-windows-arm64.tar.gz --transform='s,.*,gru.exe,' -C $(BIN_DIR) $(BINARY_NAME)-windows-arm64.exe
